...
include_once __DIR__.'/http_get.php';
$time_start = microtime( true );
$lyrics = new lyrics();
$artist = $lyrics->parce_searchwords( $argv[1] );
$song = $lyrics->parce_searchwords( $argv[2] );
...
class lyrics
{
    ...
    function parce_searchwords( $string ){
        $lower = strtolower( $string );
        $word = str_replace( ' ', '', $lower );
        return $word;
    }
